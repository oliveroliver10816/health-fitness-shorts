...
CLIPS = [
    ...
    dict(
        ...
        spoken=5.43,
        ends="The frame is unchanged from the first second: the whole upper body, still. The last of the water has passed the ring of muscle at the stomach entrance, and a clear pool is lying in the bottom of the empty stomach.",
        img=[
        ...
        cam="Locked off — the camera does not move at all for the full eight seconds. It is framed from the start on the whole upper body, from the top of the head to just below the stomach, and it stays exactly there. No push, no pull, no tilt, no drift, no shake. Water is the fastest thing that travels this tube and it needs no help from the camera; the stillness is what makes the speed visible.",
        beats=[
            ("0.0 – 2.0 s", "The throat contracts once and the water drops into the top of the esophagus, running downward immediately and visibly faster than anything else in the series."),
            ("2.0 – 4.0 s", "Rings of muscle contract behind it, but the water is already ahead of them and past the collarbones. Nothing in the frame moves except the water."),
            ("4.0 – 6.0 s", "The column passes behind the heart, which beats steadily twice in this window."),
            ("6.0 – 8.0 s", "The ring of muscle at the stomach entrance opens and the water pours through, gathering into a clear pool at the bottom of the stomach."),
        ],
    ...
    dict(
        ...
        cam="Crane up, moderate amplitude, slow and constant — the camera starts low among the villi and rises steadily through the whole eight seconds, so the field opens out beneath it and more and more of the lining comes into view. It never tilts, never rotates and never stops. The rise is the opposite of the egg video's move on this same still, and that is deliberate.",
        beats=[
            ("0.0 – 2.0 s", "The camera begins to rise from among the villi, which sway very slightly in the moving fluid below it."),
            ("2.0 – 4.0 s", "Water moves down past the lens against the villus surfaces, bending the light behind it. More of the field comes into view as the camera climbs."),
            ("4.0 – 6.0 s", "Beneath, the capillary networks inside the villi brighten and the flow within them visibly speeds up, spreading across the whole visible field rather than in one place."),
            ("6.0 – 8.0 s", "The rise slows and the camera settles looking down into one villus, its capillary running clearer and faster than at the start of the shot."),
        ],
    ...
    dict(
        ...
        cam="Pull out, very large amplitude, decelerating — the camera retreats fastest in the first two seconds and slows continuously from there, so it is barely moving by 6.0 s and stopped by 6.5 s, holding the whole figure in frame for the last second and a half. One continuous move, no rotation, no shake.",
        beats=[
            ("0.0 – 2.0 s", "Red cells stream past the lens in thin clear plasma as the camera pulls back quickly along the vessel."),
            ("2.0 – 4.0 s", "The vessel widens and joins others, branching in every direction. The retreat begins to slow."),
            ("4.0 – 6.0 s", "The camera leaves the abdomen and the whole figure resolves, its vessel tree lighting up as a fine red-and-blue network through translucent skin."),
            ("6.0 – 8.0 s", "The move stops. The network brightens evenly everywhere at once — hands, feet, head and torso together — and holds."),
        ],
    ...
    dict(
        ...
        cam="Locked off — the camera does not move at all for the full eight seconds. The whole figure is framed from the first frame and stays exactly there. No push in, no tilt, no orbit, no drift, no shake. This is the only completely static hero shot in the series and the stillness is the point.",
        beats=[
