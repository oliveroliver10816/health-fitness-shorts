...
CLIPS = [
    ...
    dict(
        ...
        spoken=5.46,
        ends="One tiny pale blue-white gas molecule alone at the centre of frame, far smaller than anything else drifting in the fluid around it, turning very slowly.",
        img=[
        ...
        cam="Hold, then push in, very large amplitude, accelerating from slow to moderate and easing off at the end — the camera holds on the whole figure, then travels forward into the abdomen, through the body wall, and ends in extreme macro on a single molecule adrift in fluid. One continuous move, no cut, no stop.",
        beats=[
            ...
            ("4.0 – 6.0 s", "The camera passes through the body wall into dark fluid. Pale points stream past the lens, out of focus, at every scale."),
            ("6.0 – 8.0 s", "The stream thins until one is left: a single very small pale blue-white molecule at the centre of frame, in focus, turning slowly — noticeably smaller than everything else drifting past it."),
        ],
    ...
    dict(
        ...
        beats=[
            ("0.0 – 2.0 s", "The camera drifts steadily to the right past the field of villi, which sway very slightly in the moving fluid. Pale points drift down from above."),
            ("2.0 – 4.0 s", "The points reach the villus surfaces and pass through them without pausing."),
            ("4.0 – 6.0 s", "Inside the villi, the capillary network shows pale points travelling along it. The sideways drift slows."),
            ("6.0 – 8.0 s", "The camera pushes in on one villus until its capillary fills the frame, and ends inside the vessel with red cells and pale points flowing along together."),
        ],
    ...
    dict(
        ...
        spoken=4.99,
        ends="The whole body seen at full length, its entire arterial and venous tree visible as a fine red-and-blue network, with pale points spread out along it and gathering at the vessel walls themselves.",
        img=[
        ...
        beats=[
            ("0.0 – 2.0 s", "Red cells and tiny pale points stream past the lens as the camera begins to retreat along the vessel."),
            ("2.0 – 4.0 s", "The vessel widens and joins others, branching in every direction around the lens. Points drift outward toward the walls as they travel."),
            ...
            ("6.0 – 8.0 s", "The pull-out eases to a stop on the whole standing figure. The pale points are spread the length of the network, brightest right at the vessel walls rather than in the middle of the flow."),
        ],
    ...
    dict(
        ...
        beats=[
            ("0.0 – 2.0 s", "The pale green-gold glow rises through the vessel network from the torso outward. The camera begins its very slow push in."),
            ("2.0 – 4.0 s", "The glow reaches the hands and the feet, and the fine vessels there fill and widen very slightly as it arrives."),
            ("4.0 – 6.0 s", "The whole network settles to a steady, even pale green-gold. The push-in eases to a stop."),
