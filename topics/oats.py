...
CLIPS = [
    ...
    dict(
        ...
        spoken=5.92,
        ends="The whole upper body is in frame. The pale cream mass has arrived at the lower end of the esophagus and the ring of muscle at the stomach entrance is opening in front of it. The stomach below is pink and empty.",
        img=[
    ...
    dict(
        ...
        cam="Hold, then push in, very large amplitude, accelerating from slow to moderate and easing off at the end — the camera holds on the whole figure, then travels forward into the abdomen, through the body wall, into the small intestine, and ends close over its inner lining. One continuous move, no cut, no stop.",
        beats=[
            ...
            ("4.0 – 6.0 s", "The camera passes through the abdominal wall into the intestine. The ridged inner surface resolves ahead, and a smooth translucent layer is visible lying over it."),
            ("6.0 – 8.0 s", "The camera settles close over the lining. Small pale particles drift through the gel layer above it — visibly slower and more reluctantly than they would through open fluid."),
        ],
    ...
    dict(
        ...
        beats=[
            ("0.0 – 2.0 s", "The camera drifts steadily to the right past the field of villi, which sway slowly under the weight of the gel lying over them."),
            ("2.0 – 4.0 s", "A few amber beads work their way down through the gel and settle against the villus surfaces. Others are still held up in the layer above."),
            ("4.0 – 6.0 s", "Those beads pass through the wall. Inside the villi, the capillary network shows amber points travelling along it, spaced well apart. The sideways drift slows."),
            ("6.0 – 8.0 s", "The camera pushes in on one villus until its capillary fills the frame, and ends inside the vessel with red cells and a few well-spaced amber beads flowing along together."),
        ],
    ...
    dict(
        ...
        cam="Pull out, very large amplitude, one constant slow speed all the way — the camera retreats continuously from inside the capillary out through the liver, out of the abdomen, and back until the whole standing figure and its entire vessel tree are in frame. One unbroken move, never stopping, never accelerating, no rotation, no shake.",
        beats=[
            ("0.0 – 2.0 s", "Red cells and evenly spaced amber beads stream past the lens as the camera begins to retreat along the vessel."),
            ...
            ("6.0 – 8.0 s", "The pull-out eases to a stop on the whole standing figure. The amber points are spread evenly through the network, and the whole thing brightens by a small, steady amount — no spike, no wave, no flare."),
        ],
    ...
    dict(
        ...
        beats=[
            ("0.0 – 2.0 s", "The gold glow rises evenly through the whole vessel network, slowly, from dim toward half strength. The camera begins its very slow push in."),
            ("2.0 – 4.0 s", "The rise continues at exactly the same rate — no acceleration, no surge — until the network is fully lit."),
            ("4.0 – 6.0 s", "The glow holds absolutely steady. The push-in eases to a stop."),
            ("6.0 – 8.0 s", "Nothing moves and nothing changes. The figure stands still, lit steady, held for the end card."),
        ],
