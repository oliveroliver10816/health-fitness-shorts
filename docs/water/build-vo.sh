#!/usr/bin/env bash
# Build the 64.000 s voice-over track for "What happens when you drink a glass of water".
#
...
OUT="${OUT:-vo-water-64s.mp3}"
WORK="$(mktemp -d)"
trap 'rm -rf "$WORK"' EXIT

S=(
"Every time you drink a glass of water, the first cool mouthful crosses your lips and tongue."
"Your esophagus carries it down in one quick wave, straight into your waiting stomach."
"Your stomach has nothing to break apart here, so the water simply passes through it."
"In your small intestine it moves across the wall alongside salt, the two travelling together."
"It crosses the lining through the tiny folds, into the vessels waiting underneath them."
"Your blood thins slightly and carries it out to every tissue in your body at once."
"Your kidneys measure what arrived, and decide how much to keep and how much to release."
"Now every cell in your body is working in the fluid it needs to do its job."
)
