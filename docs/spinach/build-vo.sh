#!/usr/bin/env bash
# Build the 64.000 s voice-over track for "What happens when you eat spinach".
#
...
OUT="${OUT:-vo-spinach-64s.mp3}"
WORK="$(mktemp -d)"
trap 'rm -rf "$WORK"' EXIT

S=(
"When you eat spinach, the bacteria living on your tongue start changing the leaves immediately."
"You swallow, and your esophagus carries that changed compound down toward your stomach."
"Your stomach acid finishes the conversion your tongue started, in the warm fluid there."
"A tiny gas molecule forms, one of the smallest signals your body uses."
"It crosses the wall of your small intestine, through the folds, into the vessels below."
"Your blood carries it out through the whole network, all the way to your vessel walls."
"The muscle in that vessel wall relaxes, and the passage through it opens wider."
"Now blood moves easily through a body that is holding its own vessels open."
)
